function showTime() {
	...
	var startDate = new Date(2021, 6, 16);
	...
	if (seconds < 10)
		seconds = "0" + seconds;
	var currentTimeString = "Dear GAOXUYANG:<br>"
		...
		+ "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp只愿执子之手,与子偕老.<br>"
